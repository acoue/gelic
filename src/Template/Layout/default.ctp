...
<head>
    ...
    <meta name="description" content="Gestion des Licenciés CNKDR">
    ...
    <div id="main">
		<header>
			<div class="container-fluid entete">
	        	<span class="header_logo"><?= $this->Html->image('logo.png', ['height' => '60px', 'title' => 'Gestion des Licenciés CNKDR']) ?></span>
	            <span class="header_titre">GeLic</span>
...
// 	   						else $module = -1;
	    					...
	    					echo $this->element('menuLicencie');
